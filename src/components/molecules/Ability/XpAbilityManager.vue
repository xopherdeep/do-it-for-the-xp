<template>
  <div class="ability-manager">
    ...
    <div v-if="viewMode === 'list'">
      <ion-list>
        <ion-item-group
          v-for="group in abilitiesByFrequency"
          :key="String(group.period)"
        >
          <ion-item-divider>
            <ion-label>{{ formatFrequency(group.period) }} Abilities</ion-label>
          </ion-item-divider>
          <ion-item
    ...
    <ion-card
      ...
      class="empty-state max-w-[80%] mx-auto my-4 h-auto max-h-[200px] text-center"
    >
