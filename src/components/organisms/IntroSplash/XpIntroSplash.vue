  ...
  <div class="xp-intro-splash" :class="{ 'active': isActive }">
    ...
    <div class="splash-container" :class="{ 'fade-in': fadeIn, 'fade-out': fadeOut }">
      ...
      <div v-if="currentSplash" class="splash-image">
        <img :src="currentSplash.image" :alt="currentSplash.alt || 'Splash image'"
      ...
      <div v-if="showText && currentSplash?.text" class="splash-text rpg-box">
        <xp-typing-text ref="typingText" :text="currentSplash.text" :speed="textSpeed" :is-rpg-styled="true"
          :sound-theme="$fx.theme.rpg" sound-type="text" @typing-complete="onTypingComplete" />
      </div>
      ...
      <div class="preload-container">
        <img v-for="(splash, i) in splashScreens" :key="i" :src="splash.image" @load="onImagePreloaded()"
          @error="onImagePreloaded()" class="preload-image">
      </div>
    </div>
  </div>
</template>
