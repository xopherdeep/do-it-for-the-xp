<template>
  <ion-content class="modal-content profile-loading-content">
    <div class="modal-overlay">
      <ion-card class="loading-card animate__animated animate__zoomIn">
        <ion-card-header>
          <ion-card-title>
            <i class="fal fa-compact-disc fa-spin mr-2 text-primary"></i>
            Loading Profile
          </ion-card-title>
        </ion-card-header>
        <ion-card-content>
          <div class="loading-content">
            <p v-if="userName">
              Loading <strong>{{ userName }}</strong>'s stats and achievements...
            </p>
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    mixins: [ionic],
    props: {
        // modalController passes props directly
      userName: {
        type: String,
        default: "",
      },
...
<style>
  ...
  /* Global style for the modal class passed to modalController */
  ...
  .profile-loading-modal .modal-wrapper {
