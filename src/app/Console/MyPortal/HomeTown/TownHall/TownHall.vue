...
import {
  ...
  IonNote, IonFab, IonFabButton, IonImg, IonButton,
  IonInfiniteScroll, IonInfiniteScrollContent, actionSheetController
} from '@ionic/vue';
import {
...
export default defineComponent({
  ...
  components: {
    ...
    IonCardContent, IonBadge, IonChip, IonList, IonItem, IonItemDivider,
    IonNote, IonFab, IonFabButton, IonImg, IonButton,
    IonInfiniteScroll, IonInfiniteScrollContent, XpLoading, 
  },
  mixins: [Ionic],
  props: {
    userId: {
      ...
      try {
        ...
        const processedPosts = posts.map(post => {
          ...
          if (post._embedded && post._embedded['wp:term'] && post._embedded['wp:term'][0]) {
            post.categories_names = post._embedded['wp:term'][0].map(term => term.name);
          }
        ...
        hasMorePosts.value = totalPages ? currentPage.value < parseInt(totalPages) : false;
