<template>
  <div class="loot-settings config-box">
    ...
    <!-- Consumables -->
    <div
      v-if="selectedChestType === 'consumable'"
      class="consumable-items mt-15"
    >
      <div class="item-grid items-3">
        <div
    ...
    >
      ...
      <ion-toggle
        :checked="isMimic"
        @ion-change="$emit('update-mimic', $event.detail.checked)"
      />
    </div>
    ...
    <div v-if="isMimic" class="mimic-details mt-10">
      ...
      <div v-if="mimicType === 'custom'" class="mimic-custom-visual mt-10">
        <div
          v-if="mimicBeast"
          class="beast-card-wrapper max-w-120 mx-auto"
          @click="$emit('open-mimic-selector')"
        >
          <XpBeastSelectorItem
        ...
        <div
          v-else
          class="beast-selection-trigger mini"
          @click="$emit('open-mimic-selector')"
        >
