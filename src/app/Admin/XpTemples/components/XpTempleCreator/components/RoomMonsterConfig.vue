  ...
  <div class="monster-settings config-box">
    <div class="header-with-action">
      ...
      <ion-button
        fill="clear"
        size="small"
        @click="$emit('open-beast-selector')"
      >
        ...
        <ion-row>
          <ion-col size="4" v-for="beast in selectedBeasts" :key="beast.id">
            <div class="beast-card-wrapper">
              ...
              />
              <div
                class="remove-beast-overlay"
                @click.stop="$emit('remove-beast', beast.id)"
              >
    ...
    <div
      v-else
      class="beast-selection-trigger large mt-10"
      @click="$emit('open-beast-selector')"
    >
    ...
    <div v-if="!isBoss" class="trap-config mt-20">
      ...
      >
        <div class="trap-info">
          <i
            class="fad fa-dungeon trap-icon"
            :class="{ neutral: !lockOnEnter }"
          ></i>
    ...
    <div v-else class="trap-config mt-20 boss-trap">
      <div class="trap-row active permanent">
        <div class="trap-info">
          ...
          <span class="trap-label boss-label"
            ><em><strong>LET'S GO!!</strong></em></span
          >
        </div>
        <ion-toggle
          :checked="true"
