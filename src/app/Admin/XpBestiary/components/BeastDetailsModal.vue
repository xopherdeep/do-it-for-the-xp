<template>
  <ion-header>
    <ion-toolbar class="rpg-box">
      <i slot="start" class="fad fa-paw-claws fa-lg ml-2"></i>

      <ion-title>Beast Details</ion-title>
      <ion-buttons slot="end">
        <ion-button @click="dismissModal" color="rpg">
      ...
      <div class="flex mb-4">
        <div class="text-center w-full">
          <h2 class="text-xl mb-2">
            Beasts are themed checklists that make tasks more fun!
          </h2>
          <p class="text-sm text-gray-600">
            Give your beast a creative name like "Kitchen Dragon" or "Laundry
            Kraken", then add specific tasks to complete.
          </p>
        </div>
      </div>
        ...
        <div class="checklist-header ion-padding-top">
          <ion-label class="font-bold mb-2 block">
            ...
            <p class="text-sm text-gray-600 font-normal">
              Add a checklist of tasks to complete (e.g. "Clean 10 plates",
              "Fold laundry").
            </p>
          </ion-label>
          <ion-button
          ...
          >
            ...
            >
              <ion-item class="checklist-item">
                ...
                <ion-reorder slot="end" color="rpg">
  ...
  <ion-footer>
    <ion-toolbar class="rpg-box">
      ...
      <ion-buttons slot="end">
        <ion-button @click="saveChanges" color="success" strong>
