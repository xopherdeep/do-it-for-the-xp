<template>
  <ion-item button detail @click="navigateToApprovals" class="approval-item">
    <i class="fad fa-shield-check fa-2x my-2" slot="start"></i>
    <ion-label>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const approvals = ref({
        chores: 10,
        rewards: 5,
        total: computed(() => approvals.value.chores + approvals.value.rewards),
