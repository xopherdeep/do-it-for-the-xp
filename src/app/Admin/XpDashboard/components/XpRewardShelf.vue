  ...
  <ion-item-sliding>
    <ion-item-options side="start">
      <ion-item-option color="warning">
        History
        <i class="fad fa-cash-register fa-lg my-2" slot="bottom"></i>
      </ion-item-option>
    </ion-item-options>
    <ion-item button detail class="reward-item" @click="navigateToRewards">
      <i slot="start" class="fad fa-grip-vertical fa-lg mr-4"></i>
      <i class="fad fa-hand-holding-box fa-2x mr-3" slot="start"></i>
      <ion-label>
        <div class="reward-header">
          <span>{{ rewards.total }} Accessories Redeemed</span>
          <ion-badge color="warning" v-if="rewards.active > 0"
            >{{ rewards.active }} Active</ion-badge
          >
        </div>
        <p>
