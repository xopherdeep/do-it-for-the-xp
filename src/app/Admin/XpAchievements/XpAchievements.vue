<template>
  ...
  >
    <ion-header>
      ...
      <ion-toolbar class="view-toggle-toolbar">
        <ion-buttons slot="end">
          <ion-button
            fill="clear"
            ...
            >
              ...
              >
                <div class="quest-card-avatar">
                  ...
                  <i
                    v-else
                    :class="getAchievementTypeIcon(achievement.type)"
                    class="fallback-icon"
                  />
                </div>
