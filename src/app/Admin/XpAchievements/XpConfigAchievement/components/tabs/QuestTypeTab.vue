        ...
        <div class="tab-content">
          ...
          >
            ...
            <div class="beast-grid">
                  ...
                  <ion-row>
                    ...
                    >
                      <div class="beast-column-content">
                        <div
                          class="beast-card-wrapper generate-beast-card"
                          :class="{ loading: isGeneratingBeast }"
                          @click="generateBeastWithAI"
                        >
                          <div class="generate-beast-content">
                            <i
                              v-if="isGeneratingBeast"
                              class="fad fa-spinner-third fa-spin fa-3x"
                            ></i>
                            <i
                              v-else
                              class="fad fa-sparkles fa-3x"
                            ></i>
              ...
              <div
                v-else
                class="empty-state beast-empty-state text-center"
              >
                ...
                <div class="empty-state-buttons">
                  <ion-button
                    ...
                    class="mt-4"
                    color="tertiary"
                    :disabled="isGeneratingBeast"
                  >
                    <i
                      v-if="isGeneratingBeast"
                      class="fad fa-spinner-third fa-spin mr-2"
                    ></i>
                    <i
                      v-else
                      class="fad fa-sparkles mr-2"
                    ></i>
