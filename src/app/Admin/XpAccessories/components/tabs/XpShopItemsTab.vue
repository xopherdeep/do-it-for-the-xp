        ...
        >
          <ion-label class="ion-text-center">
            ...
            <p class="text-small text-medium">
              Click + to stock this shop with items.
            </p>
          </ion-label>
        </ion-item>
            ...
            <ion-item class="shop-item">
              ...
              <ion-label>
                ...
                <div class="availability-badge">
                  ...
                  <span v-else class="text-warning">
                    ...
                    {{ item.availableDays.length }} Days/Week
                  </span>
                </div>
              </ion-label>
              ...
              <ion-button slot="end" fill="clear" @click="toggleEdit(index)">
                <i
                  class="fas"
                  :class="
                    editingIndex === index ? 'fa-chevron-up' : 'fa-chevron-down'
                  "
                ></i>
              </ion-button>
            </ion-item>
        ...
        itemSelectionStore.startSelection(
          ...
          (selectedIds) => {
            const newIds = selectedIds.filter(
              (id) => !shopItems.value.some((i) => i.itemId === id)
            );
            const removedIds = shopItems.value
            ...
            shopItems.value = shopItems.value.filter(
              (i) => !removedIds.includes(i.itemId)
            );
            saveShop();
          }
        );
