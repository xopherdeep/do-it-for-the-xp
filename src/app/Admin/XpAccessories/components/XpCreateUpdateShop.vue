    ...
    <ion-header>
      <ion-toolbar>
        <ion-buttons slot="start">
          <ion-back-button defaultHref="/game-master/compendium/setup/economy" />
        </ion-buttons>
    ...
    <ion-content class="ion-padding">
      <ion-list>
        <ion-item>
          ...
          <ion-input v-model="shop.name" placeholder="e.g. The Magic Emporium" />
        </ion-item>
        
        <ion-item>
          <ion-icon slot="start" :icon="documentTextOutline" />
          <ion-label position="stacked">Description</ion-label>
          <ion-textarea v-model="shop.description" placeholder="A brief description of the shop..." rows="3" />
        </ion-item>
