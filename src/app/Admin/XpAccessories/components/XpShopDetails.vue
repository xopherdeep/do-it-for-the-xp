<template>
  ...
  >
    <ion-tabs>
      ...
      <ion-tab-bar slot="bottom" color="rpg-dark" class="shop-tab-bar" v-if="shopId">
        <ion-tab-button tab="splash" :href="`/game-master/compendium/setup/economy/shops/${shopId}/splash`">
          <ion-icon :icon="bookOutline" />
          <ion-label>Info</ion-label>
        </ion-tab-button>

        <ion-tab-button tab="items" :href="`/game-master/compendium/setup/economy/shops/${shopId}/items`">
          <ion-icon :icon="shirtOutline" />
          <ion-label>Items</ion-label>
        </ion-tab-button>

        <ion-tab-button tab="hours" :href="`/game-master/compendium/setup/economy/shops/${shopId}/hours`">
          <ion-icon :icon="timeOutline" />
          <ion-label>Hours</ion-label>
        </ion-tab-button>

        <ion-tab-button tab="decorate" :href="`/game-master/compendium/setup/economy/shops/${shopId}/decorate`">
          <ion-icon :icon="brushOutline" />
          <ion-label>Shop</ion-label>
        </ion-tab-button>

        <ion-tab-button tab="clerk" :href="`/game-master/compendium/setup/economy/shops/${shopId}/clerk`">
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const pageStyle = computed(() => ({
       '--background': bgImage.value ? `url(${bgImage.value}) no-repeat center center / cover` : 'var(--ion-color-dark)',
       'position': 'relative'
    }));
