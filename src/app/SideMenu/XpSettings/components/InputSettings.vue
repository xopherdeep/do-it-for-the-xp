<template>
  <ion-card class="max-w-2xl">
    <ion-list>
      <ion-card-title> Audio Settings </ion-card-title>
      ...
      <ion-item>
        ...
        <ion-checkbox
          ...
          slot="end"
        ></ion-checkbox>
        <i class="fad fa-music fa-2x" slot="end"></i>
      </ion-item>
      ...
      <ion-item @click="play$fx">
        ...
        <ion-select
          ...
          interface="popover"
        >
          <ion-select-option value="earthbound"
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    methods: {
      ...
      turnMusicOnOff() {
        return (this as any).audioStore.turnMusicOnOff();
      },
    ...
    setup() {
      ...
      const volumeToastTimeout = ref<ReturnType<typeof setTimeout> | null>(
        null
      );
