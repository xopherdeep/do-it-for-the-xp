    ...
    methods: {
      ...
      advanceDialog() {
        ...
        if (this.isTyping) {
          ...
          const typingComponent = this.$refs
            .gpDialogText as XpTypingTextInstance;
          if (typingComponent) {
        ...
        if (this.currentDialogIndex < this.dialogBlocks.length - 1) {
          ...
          this.hasMoreDialog =
            this.currentDialogIndex < this.dialogBlocks.length - 1;
          this.isTyping = true;
        } else {
      ...
      showCustomDialog(blocks: string[]) {
        ...
        if (options.computed && options.computed.dialogBlocks) {
          options.computed.dialogBlocks = function () {
            return blocks;
          };
        }
