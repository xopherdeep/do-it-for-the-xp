  ...
  <ion-page>
    ...
    <ion-content :fullscreen="true" class="ion-padding bg-slide">
      ...
      >
        ...
        <swiper-slide>
          <ion-img :src="$requireIcon('./level.svg')" class="slide-image" />
          <ion-card class="max-w-xl">
        ...
        <swiper-slide>
          <ion-img :src="$requireIcon('./024-level.svg')" class="slide-image" />
          <ion-card class="max-w-xl">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const welcomeText = ref(
        "Welcome to XP! Your life is an adventure, and this app helps you track your progress, manage your tasks (we call them quests!), and reward yourself along the way. Get ready for a fun and fulfilling journey!"
      );
      const tasksText = ref(
        "XP transforms everyday chores and goals into exciting quests. We've blended the engaging power of gaming with practical task management to create an entertaining platform for your life's adventure. Do it for the XP!"
      );
      ...
      const handleSlideChange = (swiper) => {
        ...
        if (
          ...
          slide2Text.value &&
          !slidesCompleted.value[1]
        ) {
          slide2Text.value.startTyping();
        } else if (
          activeSlideIndex.value === 2 &&
          slide3Text.value &&
          !slidesCompleted.value[2]
        ) {
