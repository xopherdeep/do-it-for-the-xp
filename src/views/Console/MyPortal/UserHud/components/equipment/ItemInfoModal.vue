<template>
  ...
  >
    <div class="modal-content dialpad-modal icon-colors" v-if="item">
        ...
        <div class="consolidated-meta-header">
          <div class="header-left">
            <div class="item-icon-wrapper">
              <i class="fad fa-4x" :class="`fa-${item.faIcon}`"></i>
            </div>
          </div>
          <div class="header-right">
            ...
            <div class="meta-pill status" :class="{ equipped: isEquipped }">
        ...
        <div class="slot-selection-row">
          ...
          <div class="hand-group left">
            <button 
              ...
              :disabled="idx > 0"
            >
              <i class="fad" :class="getSlotIcon('left', idx)"></i>
          ...
          <div class="center-action">
            <div class="equip-status-label" :class="{ 'is-equipped': isEquipped }">
          ...
          <div class="hand-group right">
            <button 
              ...
              :disabled="idx > 0"
            >
              <i class="fad" :class="getSlotIcon('right', idx)"></i>
...
.slot-btn {
  ...
  &:hover:not(.locked) {
    ...
    i { opacity: 1; color: var(--ion-color-primary); }
    .slot-label { opacity: 1; color: var(--ion-color-primary); }
  }
  ...
  &.active {
    ...
    i { color: var(--ion-color-success); opacity: 1; }
    .slot-label { color: var(--ion-color-success); opacity: 1; }
  }
