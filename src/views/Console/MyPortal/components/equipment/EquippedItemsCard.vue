<template>
  <ion-card class="equipped mb-4 ion-flex ion-flex-column">
    <!-- Ensure flex column -->
          ...
          <div class="description">
            ...
            <div class="item-stats">
              <div v-if="infoItem.rechargeTime" class="recharge-time">
                <i class="fad fa-clock"></i> Recharge:
                {{ infoItem.rechargeTime }}
              </div>
      ...
      <div class="hand-section">
        ...
        <div class="slots-grid">
          <div
            ...
            @click="
              index === 0 && leftSlots[index]
                ? selectItem(leftSlots[index])
                : null
            "
          >
            <i
      ...
      <div class="hand-section">
        ...
        <div class="slots-grid">
          <div
            ...
            @click="
              index === 0 && rightSlots[index]
                ? selectItem(rightSlots[index])
                : null
            "
          >
            <i
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    components: {
      // Added IonButton for potential future use or consistency
      // IonButton
    },
    props: {
      equipment: {
    ...
    setup(props, { emit }) {
      // Using setup for computed property
      const isEquipped = computed(() => {
        ...
        return (
          props.leftHandItems[0]?.faIcon === infoIcon ||
      ...
      const handleEquipFromInfo = async () => {
        ...
        if (isEquipped.value) {
          ...
          if (props.leftHandItems[0]?.faIcon === props.infoItem.faIcon) {
            ...
            props.rightHandItems[0]?.faIcon === props.infoItem.faIcon
          ) {
...
<style lang="scss" scoped>
  ...
  .equipped {
    ...
    .equipped-title {
      // Renamed from ion-card-title to avoid conflict if needed
      margin-bottom: 5px;
