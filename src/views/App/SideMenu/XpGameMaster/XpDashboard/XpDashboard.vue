<template>
  <ion-page :class="$options.name">
    ...
    <ion-content >
      ...
      <div class="profile-avatars-container">
        <ion-scroll horizontal="true">
          <div class="profile-list">
            <div v-for="user in users" :key="user.id" class="profile-item" @click="impersonateUser(user)">
            ...
            <div class="profile-item add-profile" @click="openNewProfileModal">
              <ion-avatar>
                <i class="fad fa-plus-circle fa-2x"></i>
              </ion-avatar>
              <div class="username">Add Profile</div>
            </div>
          </div>
        </ion-scroll>
      </div>
      ...
      <!-- <ion-card class="stats-card icon-colors"> -->
        ...
        <!-- <ion-card-content> -->
          <ion-grid class="icon-colors">
            <ion-row>
              <ion-col size="3">
                <div class="stat-box clickable" @click="navigateTo('/game-master/compendium/achievements')">
                  <i class="fad fa-staff quest fa-2x text-success"></i>
                  <div class="stat-value">{{ stats.achievements || 0 }}</div>
                  <div class="stat-label">Quests</div>
                </div>
              </ion-col>
              <ion-col size="3">
                <div class="stat-box clickable" @click="navigateTo('/game-master/compendium/abilities')">
                  <i class="fad fa-book-spells fa-2x text-warning"></i>
                  <div class="stat-value">{{ abilities?.length || 0 }}</div>
                  <div class="stat-label">Abilities</div>
                </div>
              </ion-col>
              <ion-col size="3">
                <div class="stat-box clickable" @click="navigateTo('/game-master/compendium/accessories')">
                  <i class="fad fa-backpack fa-2x"></i>
                  <div class="stat-value">{{ rewards?.active || 80 }}</div>
                  <div class="stat-label">Accessories</div>
                </div>
              </ion-col>
              <ion-col size="3">
                <div class="stat-box clickable" @click="navigateTo('/game-master/compendium/bestiary')">
                  <i class="fad fa-dragon fa-2x text-warning"></i>
            ...
            <ion-row>
              <ion-col size="3">
                <div class="stat-box clickable" @click="navigateTo('/game-master/approvals')">
              ...
              <ion-col size="3">
                <div class="stat-box clickable" @click="navigateTo('/game-master/do-this-not-that?openDo=true')">
              ...
              <ion-col size="3">
                <div class="stat-box clickable" @click="navigateTo('/game-master/do-this-not-that?openDo=false')">
              ...
              <ion-col size="3">
                <div class="stat-box clickable" @click="navigateTo('/game-master/family-settings')">
      ...
      <!-- Quick Actions FAB -->
      <ion-fab vertical="bottom" horizontal="center" slot="fixed" class="icon-colors">
        <ion-fab-button color="black">
          <i class="fad fa-bolt fa-lg"></i>
        </ion-fab-button>
        <ion-fab-list side="top">
          <ion-fab-button  @click="navigateTo('/add-achievement')">
            <i class="fad fa-medal fa-lg"></i>
          </ion-fab-button>
          <ion-fab-button color="primary" @click="navigateTo('/game-master/badges')">
            <i class="fad fa-shield fa-lg"></i>
          </ion-fab-button>
        </ion-fab-list>
        <ion-fab-list side="start">
          <ion-fab-button color="success" @click="openBonus()">
            <i class="fad fa-thumbs-up fa-lg"></i>
          </ion-fab-button>
        </ion-fab-list>
        <ion-fab-list side="end">
          <ion-fab-button color="danger" @click="openPenalty()">
