<template>
  <ion-page :class="$options.name" class="bg-transparent">
    <ion-tabs>
    ...
    <!-- DateTime Modals -->
    <ion-modal :is-open="dueModalOpen" @didDismiss="dueModalOpen = false" :keep-contents-mounted="true" mode="ios">
      <ion-datetime id="due-by" v-model="achievement.dueByTime" presentation="time" />
      <ion-button @click="dueModalOpen = false" expand="full">OK</ion-button>
    </ion-modal>

    <ion-modal :is-open="startsModalOpen" @didDismiss="startsModalOpen = false" ref="starts" :keep-contents-mounted="true" mode="ios">
      <ion-datetime v-model="achievement.startsOn" id="starts-on" presentation="date" />
      <ion-button @click="startsModalOpen = false" expand="full">OK</ion-button>
    </ion-modal>

    <ion-modal ref="ends" :keep-contents-mounted="true" mode="ios" :is-open="endsModalOpen" @didDismiss="endsModalOpen = false">
      ...
      <ion-button @click="endsModalOpen = false" expand="full">OK</ion-button>
    </ion-modal>
    ...
    <!-- Preview Modal -->
    <ion-modal trigger="preview-achievement" :keep-contents-mounted="true" :backdrop-dismiss="true" mode="ios">
      <ion-card>
        <ion-list>
...
<script lang="ts" src="./XpAddAchievement.ts"></script>

<style lang="scss" scoped src="./_XpAddAchievement.scss"></style>
