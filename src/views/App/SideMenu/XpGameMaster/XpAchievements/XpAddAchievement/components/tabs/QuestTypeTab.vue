        ...
        <div class="tab-content">
          ...
          <div class="section-card">
            ...
            <div class="type-grid">
              <div 
                ...
                :key="type.value"
                :class="['type-option', { 'selected': adventureType === type.value }]"
                ...
                <ion-grid class="ion-no-padding">
                  <ion-row>
                    <ion-col size="6" size-md="4" v-for="beast in beasts" :key="beast.id">
                      <div 
                        :class="['beast-card-wrapper', { 'selected': achievement.beastId === beast.id }]"
                      ...
                      >
                        <XpBeastSelectorItem 
                          ...
                          :bg2="beast.bg2"
                        />
                        <div class="selected-overlay" v-if="achievement.beastId === beast.id">
          ...
          <div v-if="adventureType === 'simple'" class="dynamic-section simple-section text-center">
             <div class="empty-state">
              ...
              <p>No threats detected. This is a skill challenge or simple chore.</p>
             </div>
          </div>
