<template>
  ...
  >
    <div class="modal-content dialpad-modal">
      ...
      <div
        v-if="step === 1"
        class="dialpad-grid categories-grid"
      >
        <button
      ...
      <div
        v-else-if="step === 2 && selectedCategory"
        class="dialpad-grid types-grid"
      >
        <button
      ...
      <!-- STEP 2.5: Monster Config Selector - Delegated via slot -->
      <div
        v-else-if="step === 2.5"
        class="config-step"
      >
        <slot name="config-selector"></slot>
      </div>
