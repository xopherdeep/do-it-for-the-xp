    ...
    <ion-content class="transparent-content">
      ...
      <div v-else class="content-wrapper">
        ...
        <ion-accordion-group v-if="Object.keys(roomsByFloor).length > 0" :value="defaultOpenFloors" :multiple="true">
          ...
          >
            <ion-item slot="header" class="floor-header">
            ...
            <div slot="content" class="room-list">
              <div 
                v-for="room in rooms" 
                :key="room.symbol"
                class="room-card"
              ...
              >
                <div class="room-icon-wrapper" :class="[`type-${room.type}`]">
                ...
                <div class="room-info">
                  ...
                  <div class="room-details">
                    <span v-if="room.beasts && room.beasts.length" class="detail-badge beasts">
                      <i class="fad fa-skull"></i> {{ room.beasts.length }}
                    </span>
                    <span v-if="room.hasLoot" class="detail-badge loot">
                      <i class="fad fa-treasure-chest"></i>
                    </span>
                    <span v-if="room.isLocked" class="detail-badge locked">
        ...
        <div class="glass-card empty-state" v-else>
          <ion-icon :icon="homeOutline" class="empty-icon"></ion-icon>
          <h2>No Rooms Yet</h2>
...
export default defineComponent({
  ...
  setup() {
    ...
    const navigateToRoom = (room: RoomListItem) => {
      ionRouter.push(`/game-master/compendium/setup/temples/${templeId}/room/${room.row}/${room.col}`);
    };
