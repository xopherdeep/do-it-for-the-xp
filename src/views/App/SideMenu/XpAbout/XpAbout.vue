  ...
  <ion-page>
    <ion-content>
      <swiper pager="true">
        <swiper-slide>
          <h1>Welcome to XP!</h1>
          <img :src="$requireIcon('./mobile-game.svg')"/>
          <ion-text>
        ...
        <swiper-slide>
          <h1>Gain Levels</h1>
          <img :src="$requireIcon('./024-level.svg')"/>
          <ion-text>
          ...
          <ion-button router-link="/switch-profile?sfsd"> Start XP </ion-button>
        </swiper-slide>
      </swiper>
    </ion-content>
  </ion-page>
