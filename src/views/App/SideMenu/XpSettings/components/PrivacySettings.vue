  ...
  <ion-page :class="$options.name">
    ...
    <ion-content :fullscreen="true" class="rpg-box">
      <ion-list>
        <ion-item-group>
          ...
          <ion-item>
            ...
            <ion-toggle v-model="privacySettings.analytics" @ionChange="savePrivacySettings"></ion-toggle>
          </ion-item>
          ...
          <ion-item>
            ...
            <ion-toggle v-model="privacySettings.crashReports" @ionChange="savePrivacySettings"></ion-toggle>
          </ion-item>
        </ion-item-group>
        ...
        <ion-item-group>
          ...
          <ion-item>
            ...
            <ion-toggle v-model="privacySettings.profileVisibility" @ionChange="savePrivacySettings"></ion-toggle>
          </ion-item>
          ...
          <ion-item>
            ...
            <ion-toggle v-model="privacySettings.achievementSharing" @ionChange="savePrivacySettings"></ion-toggle>
          </ion-item>
        </ion-item-group>
      </ion-list>
      ...
      <ion-card class="settings-card">
        ...
        <ion-card-content>
          <p>You can request a copy of your data or delete your account at any time.</p>
          <ion-button expand="block" color="primary" @click="requestDataExport">
            Export My Data
          </ion-button>
          <ion-button expand="block" color="danger" class="ion-margin-top" @click="confirmDataDeletion">
            Delete My Data
          </ion-button>
        </ion-card-content>
      </ion-card>
...
export default defineComponent({
  ...
  methods: {
    ...
    async requestDataExport() {
      const toast = await toastController.create({
        message: 'Data export request submitted. You will receive an email with your data soon.',
        duration: 3000,
        position: 'bottom',
        color: 'success'
      });
    ...
    async deleteUserData() {
      ...
      const toast = await toastController.create({
        message: 'Your data has been scheduled for deletion. This process may take up to 30 days.',
        duration: 3000,
        position: 'bottom',
        color: 'danger'
      });
  ...
  setup() {
    ...
    const privacySettings = ref(savedSettings ? JSON.parse(savedSettings) : defaultSettings);
