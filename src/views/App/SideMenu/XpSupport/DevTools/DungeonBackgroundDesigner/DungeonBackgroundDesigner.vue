<template>
  <ion-page>
    ...
    <ion-content>
      ...
      >
        <ion-fab-button @click="moveDirection('north')">
          <ion-icon 
            :icon="isDoorLocked('north') ? lockClosedOutline : chevronUpOutline"
          />
        </ion-fab-button>
      </ion-fab>
      ...
      >
        <ion-fab-button @click="moveDirection('south')">
          <ion-icon 
            :icon="isDoorLocked('south') ? lockClosedOutline : chevronDownOutline"
          />
        </ion-fab-button>
      </ion-fab>
      ...
      >
        <ion-fab-button @click="moveDirection('west')">
          <ion-icon 
            :icon="isDoorLocked('west') ? lockClosedOutline : chevronBackOutline"
          />
        </ion-fab-button>
      </ion-fab>
      ...
      >
        <ion-fab-button @click="moveDirection('east')">
          <ion-icon 
            :icon="isDoorLocked('east') ? lockClosedOutline : chevronForwardOutline"
          />
        </ion-fab-button>
      </ion-fab>
    ...
    <!-- Controls Modal -->
    <ion-modal :is-open="showControlsModal" @didDismiss="showControlsModal = false">
      <ion-header>
        <ion-toolbar>
      ...
      <ion-content class="ion-padding">
        <ion-list>
          <ion-item>
            ...
            <ion-select v-model="selectedTemple" interface="popover" @ionChange="loadSelectedTemple">
          ...
          <ion-item>
            ...
            <ion-select v-model="selectedEraStyle" interface="popover" @ionChange="redrawRoom">
              <ion-select-option v-for="style in visualEraStyles" :key="style.id" :value="style.id">
                {{ style.name }}
              </ion-select-option>
            </ion-select>
          </ion-item>
          ...
          <ion-item>
            ...
            <ion-select v-model="floorStyle" interface="popover" @ionChange="redrawRoom">
          ...
          <ion-item>
            ...
            <ion-select v-model="floorPatternType" interface="popover" @ionChange="redrawRoom">
              <ion-select-option v-for="pattern in floorPatterns" :key="pattern.id" :value="pattern.id">
                {{ pattern.name }}
              </ion-select-option>
            </ion-select>
          </ion-item>
          ...
          <ion-item>
            ...
            <ion-select v-model="wallStyle" interface="popover" @ionChange="redrawRoom">
          ...
          <ion-item>
            ...
            <ion-select v-model="wallPatternType" interface="popover" @ionChange="redrawRoom">
              <ion-select-option v-for="pattern in wallPatterns" :key="pattern.id" :value="pattern.id">
                {{ pattern.name }}
              </ion-select-option>
            </ion-select>
          </ion-item>
          ...
          <ion-item>
            ...
            <ion-toggle v-model="showRoomTypeLabel" @ionChange="redrawRoom"></ion-toggle>
          </ion-item>
          ...
          <ion-item>
            ...
            <ion-toggle v-model="lockedDoors.north" @ionChange="toggleDoorLock('north')"></ion-toggle>
          </ion-item>

          <ion-item>
            <ion-label>Toggle Lock South</ion-label>
            <ion-toggle v-model="lockedDoors.south" @ionChange="toggleDoorLock('south')"></ion-toggle>
          </ion-item>

          <ion-item>
            <ion-label>Toggle Lock East</ion-label>
            <ion-toggle v-model="lockedDoors.east" @ionChange="toggleDoorLock('east')"></ion-toggle>
          </ion-item>

          <ion-item>
            <ion-label>Toggle Lock West</ion-label>
            <ion-toggle v-model="lockedDoors.west" @ionChange="toggleDoorLock('west')"></ion-toggle>
          </ion-item>
          ...
          <ion-item lines="none">
            <ion-button expand="block" @click="exportBackground">
          ...
          <ion-item lines="none">
            <ion-button expand="block" @click="resetToEntrance">
...
import { 
  ...
  refreshOutline, lockClosedOutline, keyOutline, cubeOutline,
...
export default defineComponent({
  ...
  setup() {
    ...
    const loadSelectedTemple = async () => {
      if (!templeData.value[selectedTemple.value]) {
        try {
          ...
          console.error(`Failed to load temple: ${selectedTemple.value}`, error);
        }
      }
    ...
    const showRoomDetails = () => {
      ...
      console.log(`Room type: ${currentRoomType.value}`);
    };
    ...
    const drawMiniBossRoom = (ctx: CanvasRenderingContext2D) => {
      ...
      // Draw mini-boss symbol (smaller skull)
      ctx.beginPath();
    ...
    const exportBackground = () => {
      ...
      try {
        ...
        console.error('Failed to export background:', error);
      }
    };
